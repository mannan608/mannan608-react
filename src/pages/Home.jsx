    ...
    <>
      <section className="home-banner d-flex align-items-center position-relative">
                ...
                <div className="col-12 col-lg-6 col-xl-7">
                  ...
                  <div className="animate-heading mt-2 mb-3">
                    ...
                    <h1 className="d-flex align-items-center gap-2">
                      Web <TypingText className="text-primary fw-600" />
                    </h1>
                  </div>
                  <p>
                  ...
                  <div className="download-btn">
                    <a
                      ...
                      href={resume}
                      download="Resume_of_Abdul_Mannan"
                    >
                      Download Resume
                    </a>
                  </div>
        ...
        <div className="social-media d-flex gap-3 flex-wrap flex-column">
          <a
            href="https://github.com/mannan608"
          ...
          <a
            href="https://www.facebook.com/mannan.45/"
            className="d-flex align-items-center gap-2"
          >
            <div className="icon">
          ...
          <a
            href="https://www.linkedin.com/in/mannan608"
            className="d-flex align-items-center gap-2"
          >
            <div className="icon">
        ...
        <div className="container-fluid">
          <div className="section-title d-flex align-items-center justify-content-center flex-column gap-2">
            ...
            <p className="w-75 text-center">
              ...
              technologies. Additionally, I offer WordPress theme customization
              to deliver tailored solutions for unique business needs
            </p>
          </div>
          <div className="service-grid-container mt-5">
            <div className="service-grid-item text-center">
              ...
              <p>
                I build responsive, user-centric web applications using modern
                front-end technologies to deliver seamless digital experiences
              </p>
            </div>
            ...
            <div className="service-grid-item text-center">
              <img
                ...
                alt="service-img-two"
              />
              <h4 className="mb-2">WordPress Customization</h4>
              <p>
                I customize WordPress themes and plugins to create tailored,
                dynamic websites that meet client requirements.
              </p>
            </div>
            ...
            <div className="service-grid-item text-center">
              ...
              />
              <h4 className="mb-2">Business Analyst (BA)</h4>
              <p>
                I bridge the gap between business needs and technical solutions
                by analyzing requirements and delivering actionable insights for
          ...
          <div className="row">
            <div className="col-12">
              <div className="cta-container text-center">
                <p className="text-white opacity-75">Get Started</p>
