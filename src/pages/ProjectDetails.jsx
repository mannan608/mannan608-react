              ...
              <div className="project-info">
                ...
                <div className=" d-flex flex-column gap-1 ">
                  <p>
                    ...
                    {project.technology.web_technology.join(", ")}
                  </p>
                  <p>
                    <span className="text-black fw-500">
                      Design Technologies :{" "}
                    </span>{" "}
                    {project.technology.design_technology.join(", ")}
                  </p>
                  <p>
                    <span className="text-black fw-500">Backend : </span>
                    {project.technology.backend_technology.join(", ")}
                  </p>
                  <p>
                    <span className="text-black fw-500">Database : </span>
                    {project.database}
                  </p>
                  <p>
                    <span className="text-black fw-500">
                    ...
                    {project.technology.others.join(", ")}
                  </p>
                  <p>
                    <span className="text-black fw-500">Other Tools :</span>{" "}
                    {project.technology.others_tools.join(", ")}
                  </p>
                </div>
              </div>
                ...
                <div className="mt-2">
                  ...
                  <ul>
                    {project.contribute.map((item, index) => (
                      <li key={index} className="font-16">
                        <p>{item}</p>
                      </li>
                    ))}
                  </ul>
            ...
            <div className="col-md-6 ps-5">
              <div className="projects-image w-75">
                <div
                  ...
                  onClick={() => handleShowModal(currentIndex)}
                >
                ...
                <div className="gallery-img d-flex gap-3 mt-3">
                  {project?.images?.map((img, index) => (
                    <div
                      key={index}
                      className={`g-image ${img === gallery ? "active" : ""}`}
